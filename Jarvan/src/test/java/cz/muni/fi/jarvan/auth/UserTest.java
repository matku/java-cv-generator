...
public class UserTest {
    ...
    public void testUserAlreadyExists() {
        System.out.println("Test 1: Username already exists");
        User user = new User();
    ...
    public void testUserNotExists() {
        System.out.println("Test 3: Username not exists");
        User user = new User();
    ...
    public void testEmailNotExists() {
        System.out.println("Test 4: Email not exists");
        User user = new User();
